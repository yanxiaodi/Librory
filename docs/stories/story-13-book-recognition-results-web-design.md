...
- Rendering OCR-derived candidates with metadata matches
...
- a short evidence summary from OCR or recognition context
...
- the existing temporary image storage and OCR pipeline
