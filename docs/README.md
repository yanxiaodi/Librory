...
This directory contains the product definition for Librory.

## Documents

- [PRD](./prd.md): product requirements for the AI second-hand book hunting assistant.
- [MVP Scope](./mvp-scope.md): the first version cut for delivery.
